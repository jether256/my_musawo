...
class CategoryLogged extends StatefulWidget {

  static const  String id='categories logged';


  @override
  State<CategoryLogged> createState() => _CategoryLoggedState();
}

class _CategoryLoggedState extends State<CategoryLogged> {
